...
---------------------------------------------------------------------------------------------------------------------------------------------------------]]
    ...
    ---@field n integer number of arguments passed
    ---@field callback function callback to be executed
    ---@field [integer] any arguments for callback

    ---@class TimerQueueElement: TimerQueueTask
    ---@field timeout number time between previous callback and this one
    ---@field next TimerQueueElement  next TimerQueueElement to expire after this one
    local TimerQueueElement = {}
    ...
    local unpack, max, createTimer, timerStart, timerGetElapsed, pauseTimer, resumeTimer, destroyTimer = table.unpack,
        math.max, CreateTimer, TimerStart, TimerGetElapsed,
        PauseTimer, ResumeTimer, DestroyTimer
    ...
    function TimerQueue:setTaskTimeout(task, timeout)
        ...
        task --[[@as TimerQueueElement]].timeout = timeout
