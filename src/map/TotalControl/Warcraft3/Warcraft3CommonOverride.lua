if Debug then Debug.beginFile "TotalControl/Warcraft3/Warcraft3CommonOverride" end
OnInit.module("TotalControl/Warcraft3/Warcraft3CommonOverride", function(require)
    ---@param i integer
    ---@return race
    ConvertRace = function(i)
    end
